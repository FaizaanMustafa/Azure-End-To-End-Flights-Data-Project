...
This folder defines all source code for the 'LakeflowDeclarativePipeline' pipeline:
...
* Take a look at the sample under "sample_users_lakeflowdeclarativepipeline.py" to get familiar with the syntax.
